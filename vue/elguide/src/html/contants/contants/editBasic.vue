    ...
    <div class="template">
        ...
        <div class="temp-cont">
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <el-select v-model="value3" clearable placeholder="일반게시물형">
            ...
            <!-- 19.07.04 서브카피 / 이미지 썸네일 영역 / 본문 영역 수정 및 추가 : start -->
            <el-row>
            ...
            <el-row>
                <el-col :span="4" class="required">본문</el-col>
                <el-col :span="20">
                    <el-button>소제목 추가</el-button>
                    <el-button>텍스트(Bold) 추가</el-button>
                    <el-button>텍스트(Normal) 추가</el-button>
                    <el-button>이미지 추가</el-button>
                    <el-button>유튜브 추가</el-button>
                    <div class="el-col-div">
                        <el-row>
                            <el-col :span="3">소제목<el-button type="danger" icon="el-icon-remove-outline" circle></el-button></el-col>
                            <el-col :span="21">
                                <el-input
                                    type="textarea"
                                    class="width100"
                        ...
                        <el-row>
                            <el-col :span="3">텍스트(Bold)<el-button type="danger" icon="el-icon-remove-outline" circle></el-button></el-col>
                            <el-col :span="21">
                                <el-input
                                    type="textarea"
                                    class="width100"
                        ...
                        <el-row>
                            <el-col :span="3">텍스트(Normal)<el-button type="danger" icon="el-icon-remove-outline" circle></el-button></el-col>
                            <el-col :span="21">
                                <el-input
                                    type="textarea"
                                    class="width100"
                        ...
                        <el-row>
                            <el-col :span="3">이미지<el-button type="danger" icon="el-icon-remove-outline" circle></el-button></el-col>
                            <el-col :span="21">
                                <el-upload
                                    class="file-uploader"
                                    action="https://jsonplaceholder.typicode.com/posts/"
                        ...
                        <el-row>
                            <el-col :span="3">유튜브영상ID<el-button type="danger" icon="el-icon-remove-outline" circle></el-button></el-col>
                            <el-col :span="21" class="youtube">
                                <el-input
                                    type="textarea"
                                    class="width40"
                                    :autosize="{ minRows: 1, maxRows: 100}"
            ...
            <!-- 19.07.04 서브카피 / 이미지 썸네일 영역 / 본문 영역 수정 및 추가 : end -->
        ...
        <!-- 이미지 보기 : End -->
        <!-- 등록 확인 : Start -->
        <el-dialog :visible.sync="registConfirmPop" width="20%" center>
