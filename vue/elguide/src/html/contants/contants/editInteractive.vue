    ...
    <div class="template">
        ...
        <div class="temp-cont">
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <el-select v-model="value3" clearable placeholder="인터렉티브형">
            ...
            <!-- 19.07.04 이미지 썸네일 영역 수정 및 추가 : start -->
            <el-row>
            ...
            <el-row>
                <el-col :span="4" class="required">URL</el-col>
            ...
            <!-- 19.07.04 이미지 썸네일 영역 수정 및 추가 : end -->
